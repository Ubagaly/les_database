...
use snet2309
INSERT INTO users (id, name, surname, email, phone, gender, birthday,hometown,photo_id,pass,created_ad) VALUES 
(101,'Сергей','Сергеев','qwe@asdf.qw',123123123,'m','1983-03-21','Саратов',NULL,'fdkjgsdflskdjfgsdfg142356214','2020-09-25 22:09:27.0');
...
(103,'Виктория','Водопьянова','scasotti3@usgs.gov',4187011526,'f','1984-04-06','Челябинск',NULL,'f93c320ee2275544eb1b42d8278133c343fa5030','2020-09-25 22:09:27.0');

INSERT INTO users (id,name,surname,email,phone,gender,birthday,hometown,photo_id,pass,created_ad) VALUES 
(106,'Дмитрий','Тимашов','segginton4@cam.ac.uk',4513359033,'m','1984-06-19','Казань',NULL,'e6ab5f555555fb26c7c60ddd23c8118307804330','2020-09-25 22:09:27.0')
,(107,'Владислав','Авраменко','aswaddle5@altervista.org',1874462339,'m','1987-07-07','Москва',NULL,'b25e49362b83833eece7d225717f2e285213bf25','2020-09-25 22:09:27.0')
,(108,'Алексей','Величко','fleahey6@ftc.gov',2951798252,'m','1984-11-27','Казань',NULL,'07521436ef4b4ad464ed04cdceb99f422bbbd9c5','2020-09-25 22:09:27.0')
,(109,'Артем','Филипцов','rcasley7@exblog.jp',3237322265,'m','1984-08-04','Краснодар',NULL,'5aac7b105729d4ad431db6a4e73604ecec132fa8','2020-09-25 22:09:27.0')
,(110,'Елена','Колдаева','rlantry8@pen.io',3731144657,'f','1989-08-07','Тюмень',NULL,'ba6c51c3064c20f9de84d4ed69733d9dd408e504','2020-09-25 22:09:27.0')
,(111,'Андрей','Антипов','egoatcher9@behance.net',8774858608,'m','1984-09-04','Красноярск',NULL,'16f4e6ac1aedd2d9707b56d767f452f3246e67f7','2020-09-25 22:09:27.0');

INSERT INTO users (id, name, surname, email, phone, gender, birthday, hometown, photo_id, pass, created_ad) VALUES 
(112,'Смирнов','Илья','segginrtr4@cam.ac.uk',4513359056,'m','1987-06-19','Казань',NULL,'e6ab5f555555fb26c7c60ddd23c8115678804330','2020-09-26 22:09:27.0')
,(113,'Юлия','Величко','julddle5@altervista.org',1334462339,'m','1988-07-12','Москва',NULL,'b25e49362b83833eece7d889017f2e285213bf25','2020-09-26 22:09:27.0')
,(114,'Алексей','Еременко','eereahey6@ftc.gov',2471798252,'m','1982-11-27','Казань',NULL,'07521436ef4b4ad323ed04cdceb99f422bbbd9c5','2020-09-26 22:09:27.0');
...
select * from communities order by id desc; -- ASC сортировка по возрастанию, DESC сортировка по убыванию
select surname, name, phone from users order by surname;
...
select concat(name,' ',surname,' ',phone) persons from users;
select concat(SUBSTRING(name,1,1), '. ',surname) persons from users;
select concat (name,' ',substring(surname,1,3),'.') persons from users;
select distinct hometown from users;

select * from users where hometown = 'Краснодар';
...
select name,surname, birthday 
	from users where id between 100 and 150;

select name,surname,hometown from users where hometown != 'Москва';
select name,surname,hometown from users where hometown <> 'Москва';

select name,surname,hometown from users where hometown in ('Краснодар', 'Омск', 'Ростов-на-Дону');
select name, surname, hometown, birthday from users where hometown in ('Краснодар', 'Омск') or birthday <= '1990-01-01';
...
select name, surname from users where surname like '_ом%';
...
update friend_requests 
	set status = 'approved' 
	where target_user_id = 20;
select target_user_id, status from friend_requests where target_user_id = 20;
...
INSERT INTO users (name,surname,email,phone,gender,birthday,hometown,photo_id,pass,created_ad) VALUES 
